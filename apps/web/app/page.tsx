...
const links = [
  { href: "/privacy", title: "Privacy Policy", description: "How Prangan handles your data." },
  { href: "/help", title: "Help & Support", description: "Get answers and contact us." },
  {
    href: "/delete-account",
    title: "Delete Account",
    description: "Request deletion of your Prangan account.",
  },
];
  ...
  return (
    <main className="mx-auto flex min-h-screen max-w-2xl flex-col justify-center gap-8 px-6 py-16">
      <div className="space-y-2">
        <h1 className="text-3xl font-semibold">Prangan</h1>
